...
# 		self.signatureDatabase = pickle.load(open(r"C:\User Files\Projects\New folder\pythonProject\Secured-Home\signatureData.pkl", "rb"))
# 		self.maskModel = load_model(
# 			r"C:\User Files\Projects\New folder\pythonProject\Secured-Home\Machine Learning models\Face Mask Detection Model.h5")
#
# 		self.load_images()
# 		self.create_frames()
# 		self.create_labels()
...
# 		self.extract_data()
#
# 	# C:\User Files\Projects\New folder\pythonProject\Secured-Home\GUI_DETECTOR\Images\about_off.png
# 	def load_images(self):
# 		self.home_off = ImageLoader(
# 			r'C:\User Files\Projects\New folder\pythonProject\Secured-Home\GUI_DETECTOR\Images\home_off.png')
# 		self.home_on = ImageLoader(
# 			r'C:\User Files\Projects\New folder\pythonProject\Secured-Home\GUI_DETECTOR\Images\home_on.png')
# 		self.send_off = ImageLoader(
# 			r'C:\User Files\Projects\New folder\pythonProject\Secured-Home\GUI_DETECTOR\Images\send_off.png')
# 		self.send_on = ImageLoader(
# 			r'C:\User Files\Projects\New folder\pythonProject\Secured-Home\GUI_DETECTOR\Images\send_on.png')
# 		self.logs_off = ImageLoader(
# 			r'C:\User Files\Projects\New folder\pythonProject\Secured-Home\GUI_DETECTOR\Images\logs_off.png')
# 		self.logs_on = ImageLoader(
# 			r'C:\User Files\Projects\New folder\pythonProject\Secured-Home\GUI_DETECTOR\Images\logs_on.png')
# 		self.camera_on = ImageLoader(
# 			r'C:\User Files\Projects\New folder\pythonProject\Secured-Home\GUI_DETECTOR\Images\camera_on.png')
# 		self.camera_off = ImageLoader(
# 			r'C:\User Files\Projects\New folder\pythonProject\Secured-Home\GUI_DETECTOR\Images\camera_off.png')
# 		self.theme_off = ImageLoader(
# 			r'C:\User Files\Projects\New folder\pythonProject\Secured-Home\GUI_DETECTOR\Images\theme_off.png')
# 		self.theme_on = ImageLoader(
# 			r'C:\User Files\Projects\New folder\pythonProject\Secured-Home\GUI_DETECTOR\Images\theme_on.png')
# 		self.settings_off = ImageLoader(
# 			r'C:\User Files\Projects\New folder\pythonProject\Secured-Home\GUI_DETECTOR\Images\settings_off.png')
# 		self.settings_on = ImageLoader(
# 			r'C:\User Files\Projects\New folder\pythonProject\Secured-Home\GUI_DETECTOR\Images\settings_on.png')
# 		self.about_on = ImageLoader(r'C:\User Files\Projects\New folder\pythonProject\Secured-Home\GUI_DETECTOR\Images'
# 									r'\about_on.png')
# 		self.about_off = ImageLoader(
# 			r'C:\User Files\Projects\New folder\pythonProject\Secured-Home\GUI_DETECTOR\Images\about_off.png')
#
# 		self.person = ImageLoader(
# 			r'C:\User Files\Projects\New folder\pythonProject\Secured-Home\GUI_DETECTOR\Images\person.png',
# 			size=(40, 40))
# 		self.mask = ImageLoader(
# 			r'C:\User Files\Projects\New folder\pythonProject\Secured-Home\GUI_DETECTOR\Images\wearing-mask.png',
# 			size=(40, 40))
# 		self.weapon = ImageLoader(
# 			r'C:\User Files\Projects\New folder\pythonProject\Secured-Home\GUI_DETECTOR\Images\weapon.png',
# 			size=(40, 40))
# 		self.weather = ImageLoader(
# 			r'C:\User Files\Projects\New folder\pythonProject\Secured-Home\GUI_DETECTOR\Images\weather.png',
# 			size=(40, 40))
#
...
# 										   'home', frame=self.camera_label, cap=self.cap, mpPose=self.mpPose,
# 										   pose=self.pose, mpDraw=self.mpDraw, facenet=self.facenet,
# 										   faceDetection=self.faceDetection, signatureDatabase=self.signatureDatabase,
# 										   maskModel=self.maskModel)
...
# 		self.header_text = LabelCreations(self.header, text="Welcome to our Thief Detection System", row=0, column=0,
# 										  padx=10, pady=10)
#
...
# 		self.person_detection_switch = SwitchCreations(self.detail_frame1, 100, 40, 60, 30, 60, 0, '#8a8a8a', "#8c52ff",
# 													   '#ffffff', 1, 1)
# 		self.person_detection_switch = SwitchCreations(self.detail_frame2, 100, 40, 60, 30, 60, 0, '#8a8a8a', "#8c52ff",
# 													   '#ffffff', 1, 1)
# 		self.person_detection_switch = SwitchCreations(self.detail_frame3, 100, 40, 60, 30, 60, 0, '#8a8a8a', "#8c52ff",
# 													   '#ffffff', 1, 1)
# 		self.person_detection_switch = SwitchCreations(self.detail_frame4, 100, 40, 60, 30, 60, 0, '#8a8a8a', "#8c52ff",
# 													   '#ffffff', 1, 1)
#
