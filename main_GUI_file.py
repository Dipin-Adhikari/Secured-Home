...
class MyGUI(customtkinter.CTk):
	...
	def __init__(self):
		...
		self.signatureDatabase = pickle.load(open(r"signatureData.pkl", "rb"))
		self.maskModel = load_model(
			r"Machine Learning models\Face Mask Detection Model.h5")
	...
	def load_images(self):
		self.home_off = ImageLoader(
			r'GUI_DETECTOR\Images\home_off.png')
		self.home_on = ImageLoader(
			r'GUI_DETECTOR\Images\home_on.png')
		self.send_off = ImageLoader(
			r'GUI_DETECTOR\Images\send_off.png')
		self.send_on = ImageLoader(
			r'GUI_DETECTOR\Images\send_on.png')
		self.logs_off = ImageLoader(
			r'GUI_DETECTOR\Images\logs_off.png')
		self.logs_on = ImageLoader(
			r'GUI_DETECTOR\Images\logs_on.png')
		self.camera_on = ImageLoader(
			r'GUI_DETECTOR\Images\camera_on.png')
		self.camera_off = ImageLoader(
			r'GUI_DETECTOR\Images\camera_off.png')
		self.theme_off = ImageLoader(
			r'GUI_DETECTOR\Images\theme_off.png')
		self.theme_on = ImageLoader(
			r'GUI_DETECTOR\Images\theme_on.png')
		self.settings_off = ImageLoader(
			r'GUI_DETECTOR\Images\settings_off.png')
		self.settings_on = ImageLoader(
			r'GUI_DETECTOR\Images\settings_on.png')
		self.about_on = ImageLoader(r'GUI_DETECTOR\Images'
									r'\about_on.png')
		self.about_off = ImageLoader(
			r'GUI_DETECTOR\Images\about_off.png')

		self.person = ImageLoader(
			r'GUI_DETECTOR\Images\person.png',
			size=(40, 40))
		self.mask = ImageLoader(
			r'GUI_DETECTOR\Images\wearing-mask.png',
			size=(40, 40))
		self.weapon = ImageLoader(
			r'GUI_DETECTOR\Images\weapon.png',
			size=(40, 40))
		self.weather = ImageLoader(
			r'GUI_DETECTOR\Images\weather.png',
			size=(40, 40))
